...
<script type="text/javascript">
	$(function() {
		$('#titleTD').click(function(bcode) {
			alert(bcode);
			$.ajax({
				type : "GET",
				url : "boardOne.do?bcode=" + bcode,
	...
	<div class="board">
		...
		<div class="panel panel-default">
			...
			<button type="button" class="btn btn-info btn-lg" data-toggle="modal"
				data-target="#myModal">글제목</button>
			<!-- 게시판 테이블 -->
					...
					<div class="modal-header">
						...
						<div class="modal-title">
							...
							<img id="testImg"
								...
								style="padding-left: 20%; font-size: 200%; width: 30%; height: 30%; text-align: center;">${board.title }</small>
							<br> &nbsp;&nbsp;${board.postdate } <br>&nbsp;
		 	 ...
		 	 aria-valuemin="0" aria-valuemax="100" style="width:40%;">40%
		  	 ...
		  	 -->
					...
					<div class="modal-body">
						<p style="font-size: 150%">${board.content }</p>
					</div>
