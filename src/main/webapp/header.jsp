		...
		<div id="sidebar-wrapper">
			<nav id="spy">
				<ul class="sidebar-nav nav">
					<li><a href="#anch0"> <span
							class="glyphicon glyphicon-comment"></span>&nbsp;&nbsp;&nbsp;아무말대잔치
					</a></li>
					<li><a href="#anch1"> <span
							class="glyphicon glyphicon-globe"></span>&nbsp;&nbsp;&nbsp;프로젝트
							게시판
					</a></li>
					<li><a href="#anch2"> <span
							class="glyphicon glyphicon-briefcase"></span>&nbsp;&nbsp;&nbsp;기업
							게시판
					</a></li>
					<li><a href="#anch3"> <span
							class="glyphicon glyphicon-education"></span>&nbsp;&nbsp;&nbsp;신기술
							게시판
					</a></li>
					<li><a href="#anch4"> <span
