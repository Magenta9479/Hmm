		...
		<meta charset="utf-8">
			<link href="../css/search.css" rel="stylesheet" type="text/css">
				...
				<body>
					...
					<h2>아이디/패스워드 찾기</h2></div>
					<div class="search_idpw_body">
					<h3>아이디 찾기</h3>
					<h4>이메일 :
						<input type="email" placeholder="이메일 주소를 입력해 주세요"></h4>
								<button type="button" onclick="idSearch()" id="idSearch">아이디 찾기</button>
								<br>
									<hr>
										<h3>비밀번호 찾기</h3>
										<h4>아이디 :
											<input type="text" id="searchID" placeholder="아이디를 입력해 주세요" ></h4>
													<h4>이메일 :
